...
type Skill = { title: string; val: string[] };
...
function ProjectCard({
  ...
  return (
    <motion.div
      ...
      ref={add_to_refs}
      className="relative flex flex-col gap-2 sm:gap-4 p-4 rounded-xl transition-all duration-300 hover:bg-slate-800/50 cursor-default border border-transparent hover:border-slate-700/50"
    >
      <div className="flex flex-row items-start justify-between">
        <div>
          ...
          <span className="inline-flex xs:hidden items-center gap-1.5 text-xs font-semibold text-slate-400 bg-slate-800 border border-slate-700 px-2.5 py-1 rounded-full mt-1">
            {item.company}
          </span>
        </div>

        <div className="hidden xs:block">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-400 bg-slate-800 border border-slate-700 px-2.5 py-1 rounded-full whitespace-nowrap">
            {item.company}
          </span>
        </div>
      </div>
...
export default function HomeClient({
  ...
  skill_icon_map: Record<string, React.ReactNode>;
}) {
              ...
              >
                <div className=" flex flex-row items-start justify-between">
                  <div>
                    ...
                    <span className="inline-flex  xs:hidden items-center text-xs font-semibold text-slate-400 bg-slate-800 border border-slate-700 px-2.5 py-1 rounded-full whitespace-nowrap">
                      {item.year}
                    </span>
                  </div>
